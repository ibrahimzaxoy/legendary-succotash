...
// Called once, right after an order is placed (not on page load) -
// respects "ask at the point of value" rather than prompting a guest for
// notification permission before they've done anything. Silently no-ops
// on unsupported browsers or a declined/dismissed permission prompt -
// the WebSocket-driven tracking view keeps working either way, push is
// purely additive.
