...
// One-time provisioning for a driver's phone: a manager/owner signs in to
// pick which branch this phone's deliveries come from, then their session
// is discarded - the driver signs in for their own shift afterwards via
// the PIN picker, not this screen.
  ...
  if (step === 'branch') {
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center px-6">
        <h1 className="mb-1 text-center font-heading text-2xl font-bold">Which branch is this phone for?</h1>
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <h1 className="mb-1 text-center font-heading text-3xl font-bold">Rider App Setup</h1>
        <p className="mb-8 text-center text-muted">A manager or owner sets this phone up once</p>
